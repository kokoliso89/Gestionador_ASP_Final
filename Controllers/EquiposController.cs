...
namespace LeagueMaster.Controllers
{
    ...
    public class EquiposController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Entrenador,Ciudad,Activo,Pais")] Equipos equipos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Entrenador,Ciudad,Activo,Pais")] Equipos equipos)
        {
            if (id != equipos.Id)
            {
                return NotFound();
