...
namespace LeagueMaster.Controllers
{
    ...
    public class JugadoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Edad,Posicion,Numero,Altura,Equipo")] Jugadores jugadores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Edad,Posicion,Numero,Altura,Equipo")] Jugadores jugadores)
        {
            if (id != jugadores.Id)
            {
                return NotFound();
